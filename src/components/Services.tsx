...
export default function Services() {
  ...
  [
    {
      title: "Web",
      description: "Desenvolvimento de sites e sistemas web estáticos e dinâmicos com React.js, Next.js, TypeScript, HTML e CSS.",
      icon: <HiComputerDesktop className="h-12 w-12"/>,
    },
    {
      title: "Sistemas back-end",
      description: "Desenvolvimento de sistemas e APIs REST com Node.js, Java, Spring.",
    ...
    <section className="container mx-auto my-12 max-w-4xl p-4">
      <div className="p-4 text-center">
        ...
        <p className=" text-sm text-gray-600">
          Posso atender uma gama completa de serviços, do front-and ao back-end com banco de dados e sistemas.
        </p>
      </div>
