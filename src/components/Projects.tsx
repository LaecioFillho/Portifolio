...
export default function Projects() {
  const projects = [
    {
      title: "Artigo do Android",
      description: "Página de um artigo sobre a história, criação e evolução do Android.",
      image:
      ...
      link: "https://laeciofillho.github.io/Android/codigo/android.html",
      colSpan: "col-span-1",
    },
    {
      title: "VR Engenharia",
      description: "Site de uma empresa especializada em desenvolvimentos de projetos elétricos, hidráulicos e arquitetônicos.",
      image:
      ...
      link: "https://laeciofillho.github.io/VR-Engenharia/",
      colSpan: "col-span-1 md:col-span-2",
    },
    {
      title: "Cardápio da Marmitaria",
      description: "Cardápio simples de uma marmitaria com o envio do pedido pela API do WhatsApp.",
      image:
      ...
      link: "https://laeciofillho.github.io/Marmitaria-Silvania/",
      colSpan: "col-span-1",
    },
    {
      title: "App Academia",
      description: "Site com cara de aplicativo, contendo uma rotina de exercícios para serem realizado semanalmente, com imagens dinâmicas na forma da execução",
      image:
      ...
      link: "https://laeciofillho.github.io/AleTraining/codigo/Index/home.html",
      colSpan: "col-span-1",
    },
    {
      title: "Projeto 5",
  ...
  return (
    <>
        ...
        <div className="container mx-auto max-w-4xl p-4 py-12">
          <div className="relative p-4 text-center">
            ...
            <p className="relative text-sm text-gray-400">
              Alguns dos projetos pessoais que já realizei ao longo do meu aprendizado como desenvolvedor fullstack.
            </p>
          ...
          <div className="grid grid-cols-1 p-4 gap-4 md:grid-cols-3">
            {projects.map((project, index) => (
              ...
              >
                <div className="absolute inset-0 flex h-full w-full flex-col items-center justify-center rounded-lg bg-blue-600/80 text-white opacity-0 transition-opacity group-hover:opacity-100">
      ...
      <div className="absolute right-0 -mt-[6px] h-3 w-48 rounded-l-full bg-gradient-to-r from-blue-700 to-blue-600 md:w-1/3" />
    </>
  )
}
